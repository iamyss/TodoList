...
export default class ToDo extends React.Component {
    ...
    removeList() {
        axios.post("http://localhost:8080/api/list/delete", {
                    ...
                    <Typography>{
                            ...
                            return (
                                <div key={i}>
                                    <FormControlLabel
                                        ...
                                        label={l.body}
                                    />
                                    <DeleteIcon style={{ float: "right", cursor: "hand" }} onClick={() => { this.remoteTask(i) }} />
                                </div>
                            )
                        })
                    }
                        <form onSubmit={this.addToList}>
                            <FormControl>
                                ...
                                <Input value={this.state.newTodo} onChange={e => this.setState({ newTodo: e.target.value })} id="my-input" aria-describedby="my-helper-text" />
                                <DeleteIcon style={{ color: "red", float: "right", cursor: "hand" }} onClick={this.removeList} />
                            </FormControl>
                        </form>
                    </Typography>
                </AccordionDetails>
